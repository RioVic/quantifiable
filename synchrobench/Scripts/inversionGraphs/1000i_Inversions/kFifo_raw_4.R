...
for (i in 1: length(list_files)) {
	...
	cat ("output file is ", output_file)
	...
	cat("checking for files ", n1k_file_path, n2k_file_path, n4k_file_path, n8k_file_path, n16k_file_path, n24k_file_path, n32k_file_path)
...
cat("start orders: ", tQ$start_order)
