...
struct sl_set *set, barrier_t *barrier, operation_t *operations, int thread_id);
void print_stats(thread_data_t *data, int nb_threads, struct sl_set *set);
